...
public class Agencia<T extends Cliente> {
	...
	public void ordenaClientesPorSaldo() {
		// Sort utiliza o padrao de desenho GoT Strategy, i.e, podemos variar
		// dinamicamente a estrategia de ordenacao
	...
	class ComparatorReversorSaldo implements Comparator<Cliente> {
