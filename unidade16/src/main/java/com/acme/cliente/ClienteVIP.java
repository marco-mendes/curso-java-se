...
public class ClienteVIP extends Cliente {
	...
	public ClienteVIP(Agencia<Cliente> agencia, String nome, String endereco, Optional<String> enderecoComercial,  String numeroConta, LocalDate dataNascimento) throws ContaInvalida {
	...
	public ClienteVIP(Agencia<Cliente> agencia, String nome, String endereco, Optional<String> enderecoComercial,  String numeroConta, LocalDate dataNascimento, double saldo) throws ContaInvalida {
		super(agencia, nome, endereco, enderecoComercial, dataNascimento);
		contas = new HashMap<>();
	...
	public static void main(String[] args)
		...
		ClienteVIP maria = new ClienteVIP(agencia001, "Maria", "Rua das Flores", Optional.empty(), "53321-6", dataNascimentoMaria, 500);
		...
		ClienteRegular manu = 
				new ClienteRegular(agencia001, "Manu", "Rua da Manu", Optional.empty(), "54321-6", dataNascimentoManu);
