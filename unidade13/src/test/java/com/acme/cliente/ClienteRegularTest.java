...
class ClienteRegularTest {
	...
	@Test
	@DisplayName("Teste de credito para a Maria") 
	void testCreditar() throws ContaInvalida, MovimentacaoInvalida, LimiteSaqueExcedido, LimiteChequeEspecialExcedido {
		maria.creditar(400);		
		assertEquals(900, maria.getSaldo());
	}

	@Test
	@DisplayName("Teste de debito para a Maria") 
	void testDebitar() throws MovimentacaoInvalida, LimiteSaqueExcedido, LimiteChequeEspecialExcedido {
		maria.debitar(400);		
