...
public class ClienteVIP extends Cliente {
	...
	public ClienteVIP(Agencia<Cliente> agencia, String nome, String endereco, String numeroConta, LocalDate dataNascimento) throws ContaInvalida {
		super(agencia, nome, endereco, dataNascimento);
		contas = new HashMap<>();
	...
	public ClienteVIP(Agencia<Cliente> agencia, String nome, String endereco, String numeroConta, LocalDate dataNascimento, double saldo) throws ContaInvalida {
		super(agencia, nome, endereco, dataNascimento);
		contas = new HashMap<>();
	...
	public static void main(String[] args)
		...
		ClienteVIP joao = new ClienteVIP(agencia001, "Joao", "Rua das Couves", "12345-6", dataNascimentoJoao);
		...
		ClienteVIP maria = new ClienteVIP(agencia001, "Maria", "Rua das Flores", "53321-6", dataNascimentoMaria, 500);
		...
		LocalDate dataNascimentoManu = LocalDate.of(1993, Month.JANUARY, 5);

		ClienteRegular manu = 
				new ClienteRegular(agencia001, "Manu", "Rua da Manu", "54321-6", dataNascimentoManu);
