...
public class ClienteRegular extends Cliente {
	...
	public ClienteRegular(Agencia agencia, String nome, String endereco, String numeroConta, LocalDate dataNascimento) throws ContaInvalida {
	...
	public ClienteRegular(Agencia agencia, String nome, String endereco, String numeroConta, LocalDate dataNascimento, double saldo) throws ContaInvalida {
		super(agencia, nome, endereco, dataNascimento);
	...
	public static void main(String[] args) 
		...
		ClienteRegular joao = new ClienteRegular(agencia001, "Joao", "Rua das Couves", "12345-6", dataNascimentoJoao);
		joao.creditar(1300);
		joao.debitar(600);
		System.out.println(joao);
		
		LocalDate dataNascimentoMaria = LocalDate.of(1974, Month.DECEMBER, 5);
		ClienteRegular maria = new ClienteRegular(agencia001, "Maria", "Rua das Flores", "54321-6", dataNascimentoMaria, 500);
		maria.debitar(400);
