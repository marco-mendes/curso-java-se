...
public class Agencia<T extends Cliente> {
	...
	public static void main(String[] args)
		...
		ClienteVIP maria = new ClienteVIP(agencia001, "Maria", "Rua das Flores", "54321-6", dataNascimentoMaria, 500);
		...
		ClienteVIP manu = new ClienteVIP(agencia001, "Manu", "Rua da Manu", "56789-6", dataNascimentoManu, 500);
		manu.creditar("56789-6", 10000);
		
		LocalDate dataNascimentoMatusalem = LocalDate.of(1756, Month.JULY, 13);
		ClienteVIP matusalem = new ClienteVIP(agencia001, "Matusa", "Rua do seu Matusa", "56739-6", dataNascimentoMatusalem, 500);				
